...
\documentstyle[11pt,newcent]{res} % default is 10 pt
% Use \documentstyle[11pt]{res} to get New Century
%                                   Schoolbook Postscript font
% and  \documentstyle[11pt]{res} to get default (Computer Modern) font 
