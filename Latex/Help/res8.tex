...
% Use \documentstyle[fancyhead,newcent]{res} for New Century Schoolbook 
% Postscript font and the fancyhead option for getting 2 line header
% Use \documentstyle[fancyhead]{res} to get default (Computer Modern) font 
\newsectionwidth{0pt}  % So the text is not indented under section headings
\setlength{\headrulewidth}{0pt} % suppress line drawn by default
 			        % with fancyhead
